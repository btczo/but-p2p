...
function builder(options) {
  ...
  if (!options.network) {
    options.network = but.Networks.defaultNetwork;
  }

  options.Block = options.Block || but.Block;
  options.BlockHeader = options.BlockHeader || but.BlockHeader;
  options.Transaction = options.Transaction || but.Transaction;
  options.MerkleBlock = options.MerkleBlock || but.MerkleBlock;
